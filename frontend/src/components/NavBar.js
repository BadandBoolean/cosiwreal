    ...
    return (
        (<div className={styles.NavWrapper}>
            <div className={styles.Nav}>
                ...
                <div>
                    <div className={styles.NavButton} style={{
                        ...
                        {(status === "unauthenticated") && <a href='#' onClick={handleSignin} style={{ padding: '2px', color: 'yellow', opacity: 1 }}>Log in</a>}
                        {(status === "authenticated") && <a href='#' onClick={handleSignout} style={{ padding: '2px', color: 'yellow', opacity: 1 }}>Log out</a>}
                    </div>
