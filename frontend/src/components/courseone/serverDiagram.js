    ...
    <div style={{ height: "80vh", position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            <p className={styles.underlineanim}>back</p>
          </div>
          <div style={{ cursor: "pointer" }}>
            <Link href="/courseOne/QuizOneA" legacyBehavior>
              <p className={styles.underlineanim}>Take the quiz</p>
            </Link>
          </div>
        </div>
      </div>
        ...
        {clicked && (
          <>
            <div style={{ position: "absolute" }}>
              Click the components to explore the server side
            </div>
            <div
              style={{
                position: "relative",
            ...
            >
              ...
              {redClicked & clicked ? (
                <p>
                  The web application takes in requests sent by the browser, and
                  uses the request content to dynamically generate a webpage.
                </p>
              ) : (
                <></>
              )}
            ...
            >
              {" "}
              Database
              {purpleClicked & clicked ? (
                <p>
                  A database is not necessary, but it can store data which can
                  be changed over time, such as information about the user.
                </p>
              ) : (
                <></>
              )}{" "}
