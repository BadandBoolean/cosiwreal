...
export default function PiecesProcessed() {
    ...
    return (
        ...
        <div style={{cursor: 'pointer', position: 'relative'}}><p className={styles.underlineanim}><Link href='/courseThree/QuizThreeA'><p style={{textDecoration: 'none'}}>go to quiz</p></Link></p></div>
