...
export default function QuizOneA() {
  ...
  const rightMessage =
    "Stylesheets can be stored directly on the serverside and served to the browser (client).";
      ...
      >
        <div className={styles.quizWrapper}>
          ...
          <div className={styles.questionsection}>
            <p>
              Question 1: What is an example of a static file served by the web
              server?
            </p>
            <form className={styles.questions} onSubmit={handleSubmit}>
              <label>
                <input
                  type="radio"
                  value="A stylesheet (CSS)"
                  checked={quizAnswer == "A stylesheet (CSS)"}
              ...
              <label>
                <input
                  type="radio"
                  value="A website cookie"
                  checked={quizAnswer == "A website cookie"}
                  onChange={handleChange}
                />
              ...
              <label>
                <input
                  type="radio"
                  value="Data from a database"
                  checked={quizAnswer == "Data from a database"}
                  onChange={handleChange}
                />
              ...
              {answerResult == "incorrect" && (
                ...
                >
                  ...
                  >
                    <p className={styles.underlineanim}>
                      <Link href="/courseOne/QuizOneB" legacyBehavior>
      ...
      {answerResult == "correct" && (
        ...
        >
          <div style={{ cursor: "pointer", position: "relative" }}>
            <p className={styles.underlineanim}>
              <Link href="/courseOne/QuizOneB">Next Question</Link>
            </p>
          </div>
        </div>
      )}
