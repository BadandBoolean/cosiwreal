        ...
        <>
            <div>
                ...
                <div style={bodyStyles}>
                    {csPairOpen && <ClientServerPair
                        toggleClientInfo={toggleClientInfo}
                        toggleServerInfo={toggleServerInfo}
                        clickPink={clickPink}
                        clickBlue={clickBlue} />}
                    {clientInfoOpen && <section style={{ alignItems: 'flex-start', height: '100vh', display: 'flex', justifyContent: 'center', width: '90%', alignItems: 'center', flexDirection: 'column', }}><ClientDiagram togglePair={togglePair} /></section>}
                    {serverInfoOpen && <section style={{ height: '50vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '90%', paddingBottom: '70px' }}><ServerDiagram togglePair={togglePair} /></section>}
