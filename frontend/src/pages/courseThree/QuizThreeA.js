        ...
        >
          <div className={styles.quizWrapper}>
            ...
            <div className={styles.questionsection}>
              <p>
                Question 5: When creating the HTTP module using node.js, what
                are the two values which need to be given?
              </p>
              <form className={styles.questions} onSubmit={handleSubmit}>
                <label>
                  <input
                    ...
                    checked={quizAnswer == "Name and Address"}
                ...
                <label>
                  <input
                    type="radio"
                    value="Admin Password and Route Path"
                    checked={quizAnswer == "Admin Password and Route Path"}
                    onChange={handleChange}
                  />
                ...
                <label>
                  <input
                    type="radio"
                    value="Port and Certification Key"
                    checked={quizAnswer == "Port and Certification Key"}
                    onChange={handleChange}
                  />
                ...
                <label>
                  <input
                    type="radio"
                    value="Hostname and Port"
                    checked={quizAnswer == "Hostname and Port"}
                    onChange={handleChange}
                  />
                ...
                {answerResult == "incorrect" && (
                  ...
                  >
                    ...
                    >
                      <p className={styles.underlineanim}>
                        <Link href="/courseThree/QuizThreeB" legacyBehavior>
        ...
        {answerResult == "correct" && (
          ...
          >
            <div style={{ cursor: "pointer", position: "relative" }}>
              <p className={styles.underlineanim}>
                <Link href="/courseThree/QuizThreeB" legacyBehavior>
                  <p style={{ textDecoration: "none" }}>Next Question</p>
                </Link>
              </p>
            </div>
          </div>
