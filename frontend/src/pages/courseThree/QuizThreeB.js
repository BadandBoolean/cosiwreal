...
export default function QuizTwoB({ makeUpdateScore, setCourseTwoColour }) {
    ...
    return (
        <>
            ...
            {(answerResult == "correct") && <div style={{width: '100%', display: 'flex', justifyContent: 'center', margin: '10px', padding: '0px'}}><div style={{cursor: 'pointer', position: 'relative'}}><p onClick={updateProgress} className={styles.underlineanim}><Link href='/' ><p style={{textDecoration: 'none'}}>Congratulations! You have completed Course Three. Click here to go back to the Homepage</p></Link></p></div></div>}
        </>
