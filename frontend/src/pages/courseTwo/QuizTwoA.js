                ...
                <div className={styles.questionsection}>
                    ...
                    <form className={styles.questions} onSubmit={handleSubmit}>
                        ...
                        <div style={{display: 'flex', justifyContent: 'space-between', margin: '10px'}}>
                            ...
                            <div style={{position: 'relative', margin: '0px', padding: '0px', cursor: 'pointer'}}><p className={styles.underlineanim}><Link href='/courseTwo/QuizTwoB' legacyBehavior><p style={{textDecoration: 'none'}}>Proceed</p></Link></p></div>
                        </div>
