        ...
        <div className={styles.containerWrapper}>
          <div className={styles.containerStyle}>
            <motion.div
              ...
              style={{
                background:
                  status === "authenticated" ? userDetails.progOne : "#E47A77",
              }}
              variants={oneVar}
              whileHover="hover"
              initial="hidden"
              ...
              <Link href="/courseOne" legacyBehavior>
                ...
                >
                  ...
                  >
                    ...
                    <br />
                    <br />
                    Client and Server - what are they?
                  </p>
                </div>
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              style={{
                background:
                  status === "authenticated" ? userDetails.progTwo : "#E47A77",
              }}
              variants={oneVar}
              whileHover="hover"
              initial="hidden"
              ...
              <Link href="/courseThree" legacyBehavior>
                ...
                >
                  ...
                  >
                    ...
                    <br />
                    <br />
                    In detail: Req, res on the serverside
                  </p>
                </div>
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              style={{
                background:
                  status === "authenticated" ? userDetails.progFour : "#E47A77",
              }}
              variants={oneVar}
              whileHover="hover"
              initial="hidden"
            ...
            <motion.div
              ...
              style={{
                background:
                  status === "authenticated" ? userDetails.progFive : "#E47A77",
              }}
              variants={oneVar}
              whileHover="hover"
              initial="hidden"
